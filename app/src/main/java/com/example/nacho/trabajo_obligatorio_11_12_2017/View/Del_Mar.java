...
public class Del_Mar extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_del__mar);



        /*- Lista de ofertas -*/
        lstDelMar = (ListView) findViewById(R.id.lstDelMar);
    ...
    public class ListadoPasta extends AsyncTask<Void, Void, JSONArray> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            progressDialog = new ProgressDialog(Del_Mar.this);
        ...
        protected void onPostExecute(JSONArray jsonArray) {
            ...
            if (progressDialog.isShowing()) {
                ...
                if (status == 200) {
                    ...
                    adapter = new AdapterLista(Del_Mar.this, lista, R.layout.item_lista_comida);
                    lstDelMar.setAdapter(adapter);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            ...
            case R.id.buscar:
                //Abrimos el buscador
                Intent intent = new Intent(Del_Mar.this, Search.class);
                    ...
                    public boolean onNavigationItemSelected(MenuItem menuItem) {
                        ...
                        switch (menuItem.getItemId()) {
                            case R.id.item_navigation_drawer_pasta:
                                ...
                                Intent intent = new Intent(Del_Mar.this, PastasDrawer.class);
                                finish();
                                startActivity(intent);
                            ...
                            case R.id.item_navigation_drawer_minutas:
                                ...
                                Intent intentMinutas = new Intent(Del_Mar.this, MinutasDrawer.class);
                                finish();
                            ...
                            case R.id.item_navigation_drawer_ensaladas:
                                ...
                                Intent intentEnsaladas = new Intent(Del_Mar.this, MinutasDrawer.class);
                                finish();
                            ...
                            case R.id.item_navigation_drawer_carneParrilla:
                                ...
                                Intent intentCarne = new Intent(Del_Mar.this, Carnes_Parrilla.class);
                                finish();
                            ...
                            case R.id.item_navigation_drawer_mariscos:
                                ...
                                Intent intentMariscos = new Intent(Del_Mar.this, Carnes_Parrilla.class);
                                finish();
                            ...
                            case R.id.item_navigation_drawer_registrarse:
                                ...
                                Intent intentRegistro = new Intent(Del_Mar.this, Registro.class);
                            ...
                            case R.id.item_navigation_drawer_sesion:
                                ...
                                Intent intentSesion = new Intent(Del_Mar.this, Login.class);
    ...
    private void Logout() {
        ...
        alertDialogLogout.setPositiveButton("Si", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                editor.remove("token");
                editor.commit();
                Intent intent = new Intent(Del_Mar.this, MainActivity.class);
    ...
    private void carritoSession() {
        ...
        if (loggedIn != true) {
            ...
            editor.commit();
            Intent intent = new Intent(Del_Mar.this, Login.class);
            startActivity(intent);
        } else {
            Intent intent = new Intent(Del_Mar.this, Carrito.class);
            startActivity(intent);
        }
    }
}